                    ...
                    <div class="col mb-5">
                        <div class="card h-100"   style="background-color: #f8d9d9">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a style="background-color: black; border-color: black; color: white " class="btn btn-outline-dark mt-auto" href="/user/reservefunctionhall/{{$product->id}}">Reserve</a></div>
                            </div>
                        </div>
                    </div>
            @endforeach
