...
<html lang="en">
   ...
   <header class=" py-5" style="background-color: rgb(250, 135, 41); height: 100px" >
                ...
                <div class="text-center text-dark" style="position: relative;top: -2.3rem">
                    <h2 class="display-3 ">Reservation for Treehouse</h2>
                </div>
        </header>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5" style="position: relative; top: -2rem">
                        <div class="card h-100"   style="background-color: #f8d9d9; width: 600px; position: relative; left: -10rem">
                            ...
                            <!-- Product image-->
 <img class="card-img-top" style="width: 593px; padding: 10px; height: 400px" src="{{asset('uploads/treehouses/'.$treehouse->treehouse_image)}}"alt="..." />

                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">{{ $treehouse->name }}</h5>
                                    <h6>{{ $treehouse->description }}</h6>
                                    <!-- Product price-->
                                  Php.  {{ $treehouse->price }}
                                </div>
                                   <form method="post" action="{{route('save.TreehousesReserve')}}"  enctype="multipart/form-data">
                @csrf
