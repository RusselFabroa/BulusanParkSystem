                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card">
                            <div  class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                                <img style="width: 100%;" src="{{asset('uploads/functionhalls/'.$functionhalls->functionhall_image)}}" class="img-fluid" />

                            </div>
                            <div class="card-body">
                                <h5 class="card-title">{{ $functionhalls->name }}</h5>
                                <p class="card-text">
                                    {{ $functionhalls->description }}
                                </p>
                                <h5>Price: Php{{ $functionhalls->price }}</h5>
                            </div>
                        </div>
                    </div>
                    <!--Card start-->
                    <div class="col-lg-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{route('user.save.FunctionHallReserve')}}"  enctype="multipart/form-data">
                                    @csrf
