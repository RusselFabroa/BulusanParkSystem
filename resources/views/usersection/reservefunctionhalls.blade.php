...
<?php use App\Models\functionhall; ?>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5" style="position: relative; top: -2rem">
                        <div class="card h-100"   style="background-color: #f8d9d9; width: 600px; position: relative; left: -10rem">
                            ...
                            <!-- Product image-->
 <img class="card-img-top" style="width: 593px; padding: 10px; height: 400px" src="{{asset('uploads/functionhalls/'.$functionhalls->functionhall_image)}}"alt="..." />

                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">{{ $functionhalls->name }}</h5>
                                    <h6>{{ $functionhalls->description }}</h6>
                                    <!-- Product price-->
                                  Php.  {{ $functionhalls->price }}
                                </div>
                                   <form method="post" action="{{route('save.FunctionHallReserve')}}"  enctype="multipart/form-data">
                @csrf

               <input type="hidden"  name="functionhalls_id" value="{{ $functionhalls->id }}">
               <input type="hidden" id="price"  name="price" value="{{ $functionhalls->price }}">
