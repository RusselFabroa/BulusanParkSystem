...
<h4>Reserve Function Hall Details #0000{{ $cottages['id']}}
           
    <a class="btn btn-success" style="float: right;" href="{{ url('user/historyreservefunctionhall') }}">My reservation</a></h4>
<br>
<br>

        <table class="table table-striped table-bordered">
                <tr>
                    <th>Functionhall image</th>
                    ...
                    <tr>
                        <td>
                           <img src="{{asset('uploads/functionhalls/'.$cottages['functionhall']['functionhall_image'])}}" width="70px" height="70px" alt="Image">
                        </td>
