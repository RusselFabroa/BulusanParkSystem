...
<br>
            ...
            @foreach($cottages as $history)
                <tr>
                    ...
                    <td>{{$history['pavillionhall']['name']}}</td>
                    
                    <td>{{$history['amount']}}</td>
                    <td>{{$history['status']}}</td>
                    <!--  -->
                        <td><a style="text-decoration: underline; color: green;" href="{{ url('historyreservepavillionhall/'.$history['id']) }}">View Details</a></td>
                 <!-- 
                    <td>
