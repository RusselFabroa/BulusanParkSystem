                       ...
                       <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><hr class="dropdown-divider" /></li>
                                <li><a class="dropdown-item" href="/users/pavilionhall">Pavilion hall</a></li>
                            </ul>
                        </li>
                    </ul>
                    @guest
...
<br>
            ...
            <tbody>
            @foreach($cottages as $history)
                <tr>
                    <td>#0000{{$history['id']}}</td>

                    <td>{{$history['treehouse']['name']}}</td>

                    <td>{{$history['amount']}}</td>
                    <td>{{$history['status']}}</td>
                    <!--  -->
                        <td><a style="text-decoration: underline; color: green;" href="{{ url('user/historyreservetreehouse/'.$history['id']) }}">View Details</a></td>
                 <!--
                    <td>
