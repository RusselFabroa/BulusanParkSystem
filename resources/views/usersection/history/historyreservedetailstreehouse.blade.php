...
<h4>Reserve Treehouse Details #0000{{ $cottages['id']}}

    <a class="btn btn-success" style="float: right;" href="{{ url('/user/historyreservetreehouse') }}">My reservation</a></h4>
<br>
<br>

        <table class="table table-striped table-bordered">
                <tr>
                    <th>Treehouse image</th>
                    ...
                    <tr>
                        <td>
                           <img src="{{asset('uploads/treehouses/'.$cottages['treehouse']['treehouse_image'])}}" width="70px" height="70px" alt="Image">
                        </td>
