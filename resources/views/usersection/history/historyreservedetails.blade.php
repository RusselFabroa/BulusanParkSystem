...
<h4>Reserve Cottage Details #0000{{ $cottages['id']}}
           
    <a class="btn btn-success" style="float: right;" href="{{ url('user/historyreserve') }}">My reservation</a></h4>
<br>
<br>
        ...
        <table class="table table-striped table-bordered">
                <tr>
                    ...
                    <tr>
                        <td>
                           <img src="{{asset('uploads/cottages/'.$cottages['cottage']['cottage_image'])}}" width="70px" height="70px" alt="Image">
                        </td>
