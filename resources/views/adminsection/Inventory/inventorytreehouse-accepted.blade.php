...
<div class="card" id="card-content">
    <div class="card-header">
        ...
        <ul class="nav nav-tabs" style="">
            <li class="nav-item">
                <a class="nav-link" href="/admin/inventorytreehouse" aria-current="page" >New</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" aria-current="page">Accepted</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/admin/inventorytreehouse-paid">Paid</a>
            </li>
        </ul>
    </div>
    <div class="card-body">
                ...
                @foreach($reserves as $cottage)
                    <tr>
                        ...
                        <td style="width: 10%">
                            ...
                            <a href="/admin/editinventorytresshouse/{{$cottage->id}}" id="edit-btn" class="btn btn-primary">Show</a>
