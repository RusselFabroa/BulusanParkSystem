...
<div class="card pb-5" id="card-content" >
    ...
    <div class="card-body">
        <div class="container">
            <form class="form-style-9" action="{{route('admin.update.inventorytresshouse')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                @if($errors->any())
                    <h4>{{$errors->first()}}</h4>
                @endif
                <h3>RESERVE TREEHOUSE <a class="btn btn-primary pull-right" href='/admin/inventorytreehouse'>Back to List</a> </h3>
                ...
                <input type="hidden" class="form-control" name="title" value="{{$reserves->treehouse->name}}">
                ...
                <input type="hidden" class="form-control" name="facility" value="{{$reserves->treehouse->name}}">
