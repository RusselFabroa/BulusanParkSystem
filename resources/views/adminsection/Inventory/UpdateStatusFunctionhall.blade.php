...
@csrf
<h3>Reserve for Function Hall <a href='/admin/inventoryfunctionhall'>Back to List</a> </h3>
...
<div class="container">
    <form class="form-style-9" action="{{route('admin.update.updateinventoryfunctionhall')}}" method="post" enctype="multipart/form-data">
        ...
        <h3>RESERVE FUNCTION HALL <a href='/admin/inventoryfunctionhall'>Back to List</a> </h3>
        <input type="hidden" name="id" value="{{$reserves->id}}">
        <div class="row">
