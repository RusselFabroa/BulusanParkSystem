...
<form class="form-style-9" action="{{route('update.updateinventoryfunctionhall')}}" method="post" enctype="multipart/form-data">
@csrf
<h3>Reserve for Function Hall <a href='/inventoryfunctionhall'>Back to List</a> </h3>
...
<li>
    ...
    <input type="text" name="name" readonly=""  value="{{$reserves->functionhall->name}}" class="field-style field-split align-left" placeholder="Name" />
    <input type="text" name="price" readonly=""  value="Php. {{$reserves->functionhall->price}}" class="field-style field-split align-right" placeholder="Price" />

</li>
<br>
<li>
  <!--   <input type="file" name="treehouse_image" class="field-style field-split align-left" placeholder="" /> -->
     <img src="{{asset('uploads/functionhalls/'.$reserves->functionhall->functionhall_image)}}" width="160px" height="100px" alt="Image">
        <input type="text" name="price" readonly=""  value="{{$reserves->functionhall->availability}}" class="field-style field-split align-right" placeholder="Price" />
...
<textarea readonly name="description" class="field-style"  value="{{$reserves->functionhall->description}}" placeholder="Description...">{{$reserves->functionhall->description}}</textarea>
</li>
<li>
