   ...
   @include('flash-message')
    ...
    <div class="form-group row">
        <div class="col-sm-5">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="{{$cottages->name}}">
    ...
    <div class="form-group row">
        <div class="col-sm-5">
            ...
            <input type="text" class="form-control" name="price" id="price" placeholder="Price" value="{{$cottages->price}}">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            ...
            <textarea type="text" name="description" class="form-control" id="description" placeholder="Description" >{{$cottages->description}}</textarea>
